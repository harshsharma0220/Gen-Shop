        ...
        <Layout title="Register - Ecommer app">
            <div className='form-container' style={{ minHeight: "90vh" }}>
                ...
                <h4 className="title">REGISTER FORM</h4>
                    <div className="mb-3">
                        <input type="text" value={name} onChange={(e) => setName(e.target.value)} className="form-control" id="exampleInputEmail1" placeholder='Enter Your Name' required autoFocus />
                    </div>
                    <div className="mb-3">
